...
// direction and brightness can be controlled.
//
// Interaction:
// Press the left and right arrow keys to change the direction of the sun.
// Press the up and down keys to change the sunlight brightness.
// 
// Sumanta Guha
//
...
void printInteraction(void)
{
	...
	std::cout << "Press the left and right arrow keys to change the direction of the sun." << std::endl
		<< "Press the up and down keys to change the sunlight brightness." << std::endl;
}
